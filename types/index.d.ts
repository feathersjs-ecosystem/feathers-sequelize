...
import { Params, Id, NullableId, Query, Hook } from '@feathersjs/feathers';
import { AdapterService, ServiceOptions, InternalServiceMethods, Paginated } from '@feathersjs/adapter-commons';
